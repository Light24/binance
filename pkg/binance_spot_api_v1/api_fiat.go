...
/*
FiatApiService Get Fiat Deposit/Withdraw History (USER_DATA)
...
*/
func (a *FiatApiService) GetFiatDepositWithdrawHistoryUSERDATA(ctx context.Context, transactionType int32, timestamp string, signature string, contentType string, xMBXAPIKEY string) (*http.Response, error) {
	var (
	...
	localVarQueryParams.Add("transactionType", parameterToString(transactionType, ""))
...
/*
FiatApiService Get Fiat Payments History (USER_DATA)
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param transactionType 0-deposit,1-withdraw
 * @param timestamp
 * @param signature
...
*/
func (a *FiatApiService) GetFiatPaymentsHistoryUSERDATA(ctx context.Context, transactionType int32, timestamp string, signature string, contentType string, xMBXAPIKEY string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
