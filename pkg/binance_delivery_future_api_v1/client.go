...
// APIClient manages communication with the Binance delivery futures API API v1.0
...
type APIClient struct {
	...
	DataStreamApi *DataStreamApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.DataStreamApi = (*DataStreamApiService)(&c.common)
